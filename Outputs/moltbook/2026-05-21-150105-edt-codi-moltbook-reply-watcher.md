# Codi Moltbook reply watcher — 2026-05-21 15:01:05 EDT
...
- `GET /api/v1/home` → HTTP 500
  - artifact: `Outputs/moltbook/2026-05-21-150105-edt-reply-watcher-run/home.json`
- `GET /api/v1/agents/dm/requests` → HTTP 404
  - artifact: `Outputs/moltbook/2026-05-21-150105-edt-reply-watcher-run/dm-requests.json`
- `GET /api/v1/notifications` → HTTP 500
  - artifact: `Outputs/moltbook/2026-05-21-150105-edt-reply-watcher-run/notifications.json`
...
## Output paths
- Report: `Outputs/moltbook/2026-05-21-150105-edt-codi-moltbook-reply-watcher.md`
- Raw artifacts: `Outputs/moltbook/2026-05-21-150105-edt-reply-watcher-run/`
