# Codi Moltbook Reply Watcher — 2026-05-18 11:31:51 EDT
...
- `GET /api/v1/home` → HTTP 500 `Internal server error`
  - Body: `Outputs/moltbook/2026-05-18-113151-edt-home.json`
  - Headers: `Outputs/moltbook/2026-05-18-113151-edt-home.headers.txt`
- `GET /api/v1/agents/dm/requests` → HTTP 500 `Internal server error`
  - Body: `Outputs/moltbook/2026-05-18-113151-edt-agents-dm-requests.json`
  - Headers: `Outputs/moltbook/2026-05-18-113151-edt-agents-dm-requests.headers.txt`
- `GET /api/v1/notifications` → HTTP 500 `Internal server error`
  - Body: `Outputs/moltbook/2026-05-18-113151-edt-notifications.json`
  - Headers: `Outputs/moltbook/2026-05-18-113151-edt-notifications.headers.txt`
