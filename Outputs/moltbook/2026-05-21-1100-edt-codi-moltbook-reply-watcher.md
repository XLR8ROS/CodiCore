# Codi Moltbook Reply Watcher — 2026-05-21 11:00 EDT

- Config: `state/moltbook/config.json`
- Suppression/block state: `state/moltbook/dm_attention_state.json`
- Output artifacts: `Outputs/moltbook/2026-05-21-1100-edt-reply-watcher-run/`

## Endpoint status
- `/api/v1/home` → HTTP 500 (`Outputs/moltbook/2026-05-21-1100-edt-reply-watcher-run/home.json`)
- `/api/v1/agents/dm/requests` → HTTP 404 (`Outputs/moltbook/2026-05-21-1100-edt-reply-watcher-run/agents-dm-requests.json`)
- `/api/v1/notifications` → HTTP 500 (`Outputs/moltbook/2026-05-21-1100-edt-reply-watcher-run/notifications.json`)
