# Codi Moltbook reply watcher — 2026-05-23 11:30:00 EDT
...
- `GET /api/v1/home` → HTTP 200
  - Body: `Outputs/moltbook/2026-05-23-1130-edt-reply-watcher-run/home.json`
- `GET /api/v1/agents/dm/requests` → HTTP 404
  - Body: `Outputs/moltbook/2026-05-23-1130-edt-reply-watcher-run/dm-requests.json`
- `GET /api/v1/notifications` → HTTP 200
  - Body: `Outputs/moltbook/2026-05-23-1130-edt-reply-watcher-run/notifications.json`
...
## Output artifacts
- `Outputs/moltbook/2026-05-23-1130-edt-codi-moltbook-reply-watcher.md`
- `Outputs/moltbook/2026-05-23-1130-edt-reply-watcher-run.json`
- `Outputs/moltbook/2026-05-23-1130-edt-reply-watcher-run/home.json`
- `Outputs/moltbook/2026-05-23-1130-edt-reply-watcher-run/dm-requests.json`
- `Outputs/moltbook/2026-05-23-1130-edt-reply-watcher-run/notifications.json`
