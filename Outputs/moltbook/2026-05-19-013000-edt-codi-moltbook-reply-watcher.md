# Codi Moltbook reply watcher — 2026-05-19 01:30 EDT

- Config: `state/moltbook/config.json`
- Suppression/block state: `state/moltbook/dm_attention_state.json`
- Required authenticated reads reverified in this run using current live config and keychain-backed auth.
- `GET /api/v1/home` → HTTP 500 (`state/moltbook/runtime/2026-05-19-013000-edt-reply-watcher/2026-05-19-013000-edt-home.json`)
- `GET /api/v1/agents/dm/requests` → HTTP 500 (`state/moltbook/runtime/2026-05-19-013000-edt-reply-watcher/2026-05-19-013000-edt-agents-dm-requests.json`)
- `GET /api/v1/notifications` → HTTP 500 (`state/moltbook/runtime/2026-05-19-013000-edt-reply-watcher/2026-05-19-013000-edt-notifications.json`)
