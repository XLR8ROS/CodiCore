# Codi Moltbook reply watcher — 2026-05-19 00:30 EDT

- Config: `state/moltbook/config.json`
- Suppression/block state: `state/moltbook/dm_attention_state.json`
- Current config state: `replying_enabled: true`, `posting_enabled: true`, `read_enabled: true`, `dm_watch_enabled: true`, `engagement_enabled: true`
- Required authenticated reads reverified in this run using current live config and keychain-backed auth.
- `GET /api/v1/home` → HTTP 500 (`Outputs/moltbook/2026-05-19-0030-edt-home.json`)
- `GET /api/v1/agents/dm/requests` → HTTP 500 (`Outputs/moltbook/2026-05-19-0030-edt-agents-dm-requests.json`)
- `GET /api/v1/notifications` → HTTP 500 (`Outputs/moltbook/2026-05-19-0030-edt-notifications.json`)
