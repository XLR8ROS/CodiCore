# Codi Moltbook Reply Watcher — 2026-05-22 12:30:00 EDT
...
- `home` showed `your_account.name=codicore`, `unread_notification_count: 0`, and no `activity_on_your_posts`.
- `notifications` showed only historical read notifications, including `dm_request` residue for:
