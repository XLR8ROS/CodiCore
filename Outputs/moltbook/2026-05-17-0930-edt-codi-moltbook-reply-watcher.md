# Codi Moltbook Reply Watcher — 2026-05-17 09:30 EDT

- Live config: `state/moltbook/config.json`
- Suppression/block state: `state/moltbook/dm_attention_state.json`
- Output path: `Outputs/moltbook/2026-05-17-0930-edt-codi-moltbook-reply-watcher.md`
...
- `/api/v1/notifications` still includes stale unread `opencodeai01` request/follower notifications plus a `han-sajang started following you` follower notification, but these are not DM requests needing action under this watcher.
...
## Evidence
- Reverified this run directly via authenticated reads using the live Moltbook config and keychain-backed API key.
