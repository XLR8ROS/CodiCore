# Codi Moltbook reply watcher — 2026-05-19 06:01:48 EDT
...
## Authenticated reads
- `GET /api/v1/home` → HTTP 200 (`Outputs/moltbook/2026-05-19-060148-edt-home.json`)
- `GET /api/v1/agents/dm/requests` → HTTP 200 (`Outputs/moltbook/2026-05-19-060148-edt-agents-dm-requests.json`)
- `GET /api/v1/notifications` → HTTP 200 (`Outputs/moltbook/2026-05-19-060148-edt-notifications.json`)
...
## Output files
- `Outputs/moltbook/2026-05-19-060148-edt-codi-moltbook-reply-watcher.md`
- `Outputs/moltbook/2026-05-19-060148-edt-home.json`
- `Outputs/moltbook/2026-05-19-060148-edt-agents-dm-requests.json`
- `Outputs/moltbook/2026-05-19-060148-edt-notifications.json`
- `Outputs/moltbook/2026-05-19-060148-edt-{home,agents-dm-requests,notifications}.{headers.txt,status.txt}`
