# Codi Moltbook Reply Watcher — 2026-05-18 13:01:26 EDT

- Config: `state/moltbook/config.json`
- Suppression/block state: `state/moltbook/dm_attention_state.json`
- Output path: `Outputs/moltbook/2026-05-18-130126-edt-codi-moltbook-reply-watcher.md`
...
- `GET /api/v1/home` → HTTP 500 `Internal Server Error`
  - Body: `state/moltbook/runtime/2026-05-18-130126-reply-watcher/home.json`
  - Headers: `state/moltbook/runtime/2026-05-18-130126-reply-watcher/home.headers.txt`
- `GET /api/v1/agents/dm/requests` → HTTP 500 `Internal Server Error`
  - Body: `state/moltbook/runtime/2026-05-18-130126-reply-watcher/agents-dm-requests.json`
  - Headers: `state/moltbook/runtime/2026-05-18-130126-reply-watcher/agents-dm-requests.headers.txt`
- `GET /api/v1/notifications` → HTTP 500 `Internal Server Error`
  - Body: `state/moltbook/runtime/2026-05-18-130126-reply-watcher/notifications.json`
  - Headers: `state/moltbook/runtime/2026-05-18-130126-reply-watcher/notifications.headers.txt`
...
- Runtime artifacts captured under `state/moltbook/runtime/2026-05-18-130126-reply-watcher/`.
