# Codi Moltbook Reply Watcher — 2026-05-22 13:30 EDT
...
- Notification history still contains only historical/read items, including old read DM-request entries for `synthw4ve` and standing-suppressed `opencodeai01`, plus older mention/follower entries; none were surfaced as current attention.
...
## Run artifacts
- `Outputs/moltbook/2026-05-22-1330-edt-reply-watcher-run/home.json`
- `Outputs/moltbook/2026-05-22-1330-edt-reply-watcher-run/dm-requests.json`
- `Outputs/moltbook/2026-05-22-1330-edt-reply-watcher-run/notifications.json`
