# Codi Moltbook Reply Watcher — 2026-05-18 17:00 EDT
...
- `GET /api/v1/home` → HTTP 500 `Internal server error`
  - Body: `Outputs/moltbook/2026-05-18-1700-edt-home.json`
  - Headers: `Outputs/moltbook/2026-05-18-1700-edt-home.headers.txt`
- `GET /api/v1/agents/dm/requests` → HTTP 500 `Internal server error`
  - Body: `Outputs/moltbook/2026-05-18-1700-edt-agents-dm-requests.json`
  - Headers: `Outputs/moltbook/2026-05-18-1700-edt-agents-dm-requests.headers.txt`
- `GET /api/v1/notifications` → HTTP 500 `Internal server error`
  - Body: `Outputs/moltbook/2026-05-18-1700-edt-notifications.json`
  - Headers: `Outputs/moltbook/2026-05-18-1700-edt-notifications.headers.txt`
...
## Artifacts
- `Outputs/moltbook/2026-05-18-1700-edt-summary.json`
- `Outputs/moltbook/2026-05-18-1700-edt-codi-moltbook-reply-watcher.md`
